...
class $AssetsFontsGen {
  ...
  /// File path: assets/fonts/Rubik-Black.ttf
  String get rubikBlack => 'assets/fonts/Rubik-Black.ttf';

  /// File path: assets/fonts/Rubik-Bold.ttf
  String get rubikBold => 'assets/fonts/Rubik-Bold.ttf';

  /// File path: assets/fonts/Rubik-Medium.ttf
  String get rubikMedium => 'assets/fonts/Rubik-Medium.ttf';

  /// File path: assets/fonts/Rubik-Regular.ttf
  String get rubikRegular => 'assets/fonts/Rubik-Regular.ttf';

  /// File path: assets/fonts/Rubik-SemiBold.ttf
  String get rubikSemiBold => 'assets/fonts/Rubik-SemiBold.ttf';
...
class $AssetsImagesGen {
  ...
  AssetGenImage get eventlyBrandingBackgroundImg =>
      const AssetGenImage('assets/images/evently_branding_background_img.png');

  /// File path: assets/images/evently_splash_background_img.png
